...
# set directory and project path of title scoring
title_dir = '/Users/Gabi/Documents/dev/titles/data/input/'
...
# read title matrix
title_matrix = load_xl(root_dir = title_dir, file_name = scoring_file, sheetname = 'title_matrix')
...
mapping_df = load_xl(root_dir = title_dir, file_name = scoring_file, sheetname = 'mapping')
mapping = mapping_df.set_index('old').to_dict('s')

# load actual:sfdc mapping
level_mapping_df = load_xl(root_dir = title_dir, file_name = scoring_file, sheetname = 'level_mapping')
# list of all levels
levels = level_mapping_df.Actual.tolist()
level_mapping = level_mapping_df.set_index('Actual').to_dict()

# load keywords:points mapping
keyword_df = load_xl(root_dir = title_dir, file_name = scoring_file, sheetname = 'keywords')
...
not_match_df = load_xl(root_dir = title_dir, file_name = scoring_file, sheetname = 'no_match_levels')
